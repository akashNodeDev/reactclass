...
const ResturantCard = ({name,cuisines,avgRating}) => {
...
const Body = () => {
  return (
    <div className="resturant-list">
      <ResturantCard name={resturantData[0].info.name} cuisines={resturantData[0].info.cuisines} avgRating={resturantData[0].info.avgRating}/>
